...
The complete code for this project can be located in the git repository as well as via links for each stage. 

Data Prep (Rfile) : https://github.com/ckornafel/Ciphertext-Project/blob/master/Code/Ciphertext_Data_Prep.R

First Attempt (Python) : https://github.com/ckornafel/Ciphertext-Project/blob/master/Code/Cyphertext_machine_learning.py

Second Attempt (Python) : https://github.com/ckornafel/Ciphertext-Project/blob/master/Code/CipherOneHotLetter.py

Third Attempt (Python) : https://github.com/ckornafel/Ciphertext-Project/blob/master/Code/Ciphertext_translation.py

Third Attempt (Rfile) : https://github.com/ckornafel/Ciphertext-Project/blob/master/Code/H2OToken.R
...
Jump to First Attempt Documentation: https://github.com/ckornafel/Ciphertext-Project/blob/master/First_Attempt.html
