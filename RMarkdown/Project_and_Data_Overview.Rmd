...
Data Prep (Rfile) : https://github.com/ckornafel/cyphertext/blob/master/Ciphertext/Data/Prep.R

First Attempt (Python) : https://github.com/ckornafel/cyphertext/blob/master/Cyphertext_machine_learning.py

Second Attempt (Python) : https://github.com/ckornafel/cyphertext/blob/master/CipherOneHotLetter.py

Third Attempt (Python) : https://github.com/ckornafel/cyphertext/blob/master/Cipher text_translation.py
Third Attempt (Rfile) : https://github.com/ckornafel/cyphertext/blob/master/H2OToken.R
